<%-- 
    Document   : view_organ_request
    Created on : Jun 25, 2020, 1:46:12 PM
    Author     : MY PC
--%>
...
<html>
    <head>
        ...
        <title>View Organ Request</title>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="../logout.jsp"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
        ...
        <h2 align="center" style="color: #003b99"><b>Organ Requesters Details</b></h2><br>
        ...
        String str="select r_id,name,fmh_name,email,address,phone,age,gender,request_by,support_name,"
                + "h_name,h_email,request_for,blood,required_date,reason from request_form where h_email='"+mail+"'";     
        ...
        while(rs.next())
        {
         ...
         <tr>
             ...
             <td>
                 ...
                 <a href="view_organ_availability.jsp?riid=<%=rs.getString("r_id")%>" class="btn btn-primary" >Available</a>
             </td>
